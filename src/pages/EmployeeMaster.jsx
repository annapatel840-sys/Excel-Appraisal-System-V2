...
export function EmployeeMaster() {
  ...
  // what this role may see / do (comes from the backend /me endpoint)
  const allowedTabs = permissions?.employeeMasterTabs || ["roster"];
    ...
    <AppShell>
      <div className="employee-master-page">
        ...
        <div className="em-tabs">
          ...
          {allowedTabs.includes("eligibility") && (
            <button
              type="button"
              className={activeTab === "eligibility" ? "active" : ""}
              onClick={() => setActiveTab("eligibility")}
          ...
          {allowedTabs.includes("appraisal-cycle") && (
            <button
              type="button"
              className={activeTab === "appraisal-cycle" ? "active" : ""}
              onClick={() => setActiveTab("appraisal-cycle")}
          ...
          {allowedTabs.includes("payroll-data") && (
            <button
              type="button"
              className={activeTab === "payroll-data" ? "active" : ""}
              onClick={() => setActiveTab("payroll-data")}
          ...
          {allowedTabs.includes("payroll-upload") && (
            <button
              type="button"
              className={activeTab === "payroll-upload" ? "active" : ""}
              onClick={() => setActiveTab("payroll-upload")}
          ...
          <div className="em-tab-content">
            ...
            {loading ? (
              ...
              <EmployeeRosterTable
                ...
                totalCount={rosterPagination.totalCount}
                onToggleStatus={
                  canChangeStatus ? toggleEmployeeStatus : undefined
                }
                onBulkStatusChange={
                  canChangeStatus ? bulkUpdateEmployeeStatus : undefined
                }
                bulkStatusUpdating={statusActionLoading}
              />
            )}
