    ...
    children: [
      _jsx(PopoverTrigger, {
        ...
        children: _jsx("button", {
          ...
          children: _jsx(Filter, { className: "size-3.5" }),
        }),
      }),
          ...
          current.kind === "text" &&
            _jsxs("div", {
              ...
              children: [
                _jsxs(Select, {
                  value: current.op,
                  onValueChange: (op) => onChange({ ...current, op: op }),
                  children: [
                    _jsx(SelectTrigger, {
                      className: "h-8",
                ...
                _jsx(Input, {
                  ...
                  placeholder: "Value",
                  onChange: (e) =>
                    onChange({ ...current, value: e.target.value }),
                }),
              ],
            }),
          current.kind === "number" &&
                    ...
                    _jsxs("div", {
                      ...
                      children: [
                        _jsx(Label, {
                          ...
                          children: current.op === "between" ? "From" : "Value",
                        }),
                        _jsx(Input, {
                          className: "h-8 num",
                          type: "number",
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          ...
                          _jsx(Input, {
                            ...
                            onChange: (e) =>
                              onChange({ ...current, value2: e.target.value }),
                          }),
                        ],
                      }),
                  ],
