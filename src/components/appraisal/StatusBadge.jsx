...
const map = {
  ...
  "In Progress":
    "bg-status-progress/14 text-status-progress ring-status-progress/30",
  Completed:
    "bg-status-completed/12 text-status-completed ring-status-completed/25",
  Submitted:
    "bg-status-submitted/14 text-status-submitted ring-status-submitted/30",
};
